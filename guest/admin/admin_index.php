                    ...
                    <table cellpadding="3" style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td  class="default_top_centercontent1 dtc2" >
                                <a href="admin_delete.php?message_id=<?php echo $row['id']?>">删除</a>&nbsp;<a href="admin_update.php?message_id=<?php echo $row['id']?>">修改</a>
                            </td>
	                       </tr>
						   <?php
						  ...
						  <tr>
                            ...
                            <td colspan="2" class="huifu_neirong"><span><?php echo $i;?>#回复：</span><?php echo $rowa['backcontent']?></td>
                            <td class="huifu_time"><?php $rowa['backtime'];?></td>
                        </tr>
							<?php
							$i++;
								}
